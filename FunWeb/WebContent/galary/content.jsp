...
<ul>
			<li><a href="../center/notice.jsp">게시판</a></li>
				<li><a href="../center/fnotice.jsp">파일첨부게시판</a></li>
...
<%
	...
	<tr><td>첨부파일</td><td colspan="3"><a href="../upload/<%=bb.getFile() %>">
	<img src="../upload/<%=bb.getFile() %>" width="50" height="50"></a> 
	...
	<td colspan="2"><input type="button" value="답글쓰기" onclick="location.href='rewriteForm.jsp?num=<%=bb.getNum()%>'"></td>
