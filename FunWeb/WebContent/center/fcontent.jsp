...
<tr><td class="twrite">파일</td><td><img src="../upload/<%=bb.getFile()%>"><a href="../upload/<%=bb.getFile()%>"><%=bb.getFile() %></a><a href="file_down.jsp?file_name=<%=bb.getFile() %>"><%=bb.getFile()%></a></td></tr>
